...
def upload():
    ...
    if file and allowed_file(file.filename):
        ...
        if resume_data:
            ...
            if "Work Experience" or "WORK EXPERIENCE" in resume_text:
                resume_score = resume_score+20
            else:
                resume_score = resume_score-20

            if "Personal Projects" or "PERSONAL PROJECTS" or "Projects" or "PROJECT" in resume_text:
                resume_score = resume_score+20
            else:
                resume_score = resume_score-20
            ...
            # if "CERTIFICATIONS" or "Certification" in resume_text:
            #     resume_score = resume_score+20
            # else:
            #     resume_score = resume_score-20
